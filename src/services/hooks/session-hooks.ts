...
import { clearSessionCache } from "../../hooks/tool-execute";
...
/**
 * Minimal context passed to session hooks.
 * Mirrors the fields used from HookBuilderContext without importing it
 * (avoids circular dependency with the barrel file).
 */
...
/**
 * Build the event, experimental.chat.system.transform,
 * and experimental.session.compacting hook handlers.
 */
